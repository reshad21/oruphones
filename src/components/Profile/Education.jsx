...
const Education = () => {
    return (
        <div>
            ...
            <div className="px-5 py-2 border-2 border-slate-300 rounded-3xl items-center mb-5">
                ...
                <p className='text-sm'>Lorem ipsum dolor sit amet consectetur. Erat auctor a aliquam vel congue luctus. Leo diam cras neque mauris ac arcu elit ipsum dolor sit amet consectetur.</p>
            </div>
        </div>
    );
};
